                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="clinicFirstName" className="block text-sm font-medium text-gray-700 mb-1">First Name*</label>
                                <input type="text" id="clinicFirstName" name="firstName" required className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#0a4373] focus:border-transparent outline-none transition-all" />
                            </div>
                            <div>
                                <label htmlFor="clinicLastName" className="block text-sm font-medium text-gray-700 mb-1">Last Name*</label>
                                <input type="text" id="clinicLastName" name="lastName" required className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#0a4373] focus:border-transparent outline-none transition-all" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="clinicWebsite" name="website" required placeholder="www.example.com" className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#0a4373] focus:border-transparent outline-none transition-all" />
                        </div>

                        <div>
                            <label htmlFor="clinicMessage" className="block text-sm font-medium text-gray-700 mb-1">Message*</label>
                            <textarea id="clinicMessage" name="message" required rows={4} className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#0a4373] focus:border-transparent outline-none transition-all"></textarea>
                        </div>
